...
#   timestamp: 2025-12-06T11:46:33+00:00
...
class GenerationParameters(BaseModel):
    ...
    thinking_blocks: Optional[List[Dict[str, Any]]] = Field(
        None, description='Thinking/reasoning configuration blocks (e.g., Gemini thinking config)'
    )
...
class Choice(BaseModel):
    ...
    finish_reason: Optional[FinishReason] = Field(None, description='Completion reason')
